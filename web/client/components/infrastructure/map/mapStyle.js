...
export const infrastructureMapStyle = (() => {
    let style = {
        "version": 8, "sources": {
            "osm": {
                "type": "vector", "tiles": [`/tiles/{z}/{x}/{y}.mvt`], "maxzoom": 20
            }, "station-routes": {
                "type": "geojson", "data": {
        ...
        }, "glyphs": `${origin}/font/{fontstack}/{range}.pbf`, "layers": [{
            ...
            "filter": ["==", "rail", "primary"],
            "paint": {
                "line-color": "#444", "line-width": 2.0
            }
        }, {
            "id": "station-route-layer", "type": "line", "source": "station-routes", "layout": {
            ...
            "maxzoom": 24,
            "paint": {
                "circle-color": "#ff0000", "circle-radius": ['interpolate', ['linear'], ['zoom'], 10, 1, 20, 19]
            }
        }, {
            "id": "interlocking-route-layer", "type": "line", "source": "interlocking-routes", "layout": {
                "line-join": "round", "line-cap": "round"
            }, "paint": {
                "line-color": "#ff0000", "line-width": 6
            }
