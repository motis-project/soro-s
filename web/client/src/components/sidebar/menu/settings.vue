<template>
  <soro-collapsible label="Settings">
    ...
    >
      <v-btn :value="DarkLightModes.OS"> OS</v-btn>
      <v-btn :value="DarkLightModes.LIGHT"> Light</v-btn>
      <v-btn :value="DarkLightModes.DARK"> Dark</v-btn>
    </v-btn-toggle>

    <v-sheet title="some" class="d-flex accent-color-picker">
...
export default defineComponent({
  ...
  computed: {
    ...mapState(SettingsNamespace, ['darkLightModePreference', 'primaryColor'])
  },
